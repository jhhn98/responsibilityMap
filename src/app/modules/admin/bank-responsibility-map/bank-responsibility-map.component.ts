...
@Component({
    selector: 'app-bank-responsibility-map',
    imports: [
        FormsModule,
        ReactiveFormsModule,
        RouterLink,
    ...
    templateUrl: './bank-responsibility-map.component.html',
    styleUrl: './bank-responsibility-map.component.scss',
})
export class BankResponsibilityMapComponent {
