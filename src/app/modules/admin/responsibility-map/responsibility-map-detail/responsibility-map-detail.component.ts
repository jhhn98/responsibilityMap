...
@Component({
    selector: 'app-responsibility-map-detail',
    standalone: true,
    imports: [RouterOutlet, RouterLink, RouterLinkActive, MatButton],
    templateUrl: './responsibility-map-detail.component.html',
    styleUrls: ['./responsibility-map-detail.component.scss'],
})
export class ResponsibilityMapDetailComponent implements AfterViewInit {
